...
int main()
{
	...
	RuedaDerechaAdelante.LoadModel("Models/RuedaDerechaAdelante.obj");

	RuedaDerechaAtras = Model();
	RuedaDerechaAtras.LoadModel("Models/RuedaDerechaAdras.obj");

	RuedaIzqAdelante = Model();
	RuedaIzqAdelante.LoadModel("Models/RuedaIzqAdelante.obj");

	RuedaIzqAtras = Model();
	RuedaIzqAtras.LoadModel("Models/RuedaIzqAtras.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 7.0f, mainWindow.getarticulacion5())); //0.0f, 0.4f, -1.5f
