	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		spotLights[0].SetFlash(faroAzul, glm::vec3(0.0f, 0.0f, 1.0f));

		if (mainWindow.getLuzDelante() == 1) {
			//Luz azul faro que sigue al coche
			glm::vec3 faroAzul = glm::vec3(model[3][0] + 3.0f, model[3][1] + 2.0f, model[3][2] + 4.0f);
			spotLights[0].SetFlash(faroAzul, glm::vec3(0.0f, 0.0f, 1.0f));
			//Se apaga la roja
			//Luz azul faro que sigue al coche
			glm::vec3 faroRojo = glm::vec3(100.0f, 100.0f, 100.0f);
			spotLights[2].SetFlash(faroRojo, glm::vec3(0.0f, 0.0f, 1.0f));
		}
		else if (mainWindow.getLuzTrasera() == 1) {
			//Luz azul faro que sigue al coche
			glm::vec3 faroAzul = glm::vec3(100.0f, 100.0f, 100.0f);
			spotLights[0].SetFlash(faroAzul, glm::vec3(0.0f, 0.0f, 1.0f));
			//Se apaga la roja
			//Luz azul faro que sigue al coche
			glm::vec3 faroRojo = glm::vec3(model[3][0] + 3.0f, model[3][1] + 2.0f, model[3][2] + 4.0f);
			spotLights[2].SetFlash(faroRojo, glm::vec3(0.0f, 0.0f, -1.0f));
		}
		...
		//Arco y letrero 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(70.0f, 30.0f, 6.0f));
		...
		spotLights[1].SetFlash(centro, glm::vec3(0.0f, -1.0f, 0.0f));
